# Wrapper script for HSL_jll for powerpc64le-linux-gnu-libgfortran3
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libhsl,
        "lib/powerpc64le-linux-gnu-libgfortran3/libhsl.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset,
        "lib/powerpc64le-linux-gnu-libgfortran3/libhsl_subset.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset_64,
        "lib/powerpc64le-linux-gnu-libgfortran3/libhsl_subset_64.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
