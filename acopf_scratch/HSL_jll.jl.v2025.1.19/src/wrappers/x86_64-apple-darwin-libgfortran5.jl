# Wrapper script for HSL_jll for x86_64-apple-darwin-libgfortran5
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libhsl,
        "lib/x86_64-apple-darwin-libgfortran5/libhsl.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset,
        "lib/x86_64-apple-darwin-libgfortran5/libhsl_subset.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset_64,
        "lib/x86_64-apple-darwin-libgfortran5/libhsl_subset_64.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
