# Wrapper script for HSL_jll for x86_64-linux-gnu-libgfortran4
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libhsl,
        "lib/x86_64-linux-gnu-libgfortran4/libhsl.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset,
        "lib/x86_64-linux-gnu-libgfortran4/libhsl_subset.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset_64,
        "lib/x86_64-linux-gnu-libgfortran4/libhsl_subset_64.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
