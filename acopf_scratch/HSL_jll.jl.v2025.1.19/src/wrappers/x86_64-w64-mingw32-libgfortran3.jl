# Wrapper script for HSL_jll for x86_64-w64-mingw32-libgfortran3
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libhsl,
        "bin\\x86_64-w64-mingw32-libgfortran3\\libhsl.dll",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset,
        "bin\\x86_64-w64-mingw32-libgfortran3\\libhsl_subset.dll",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libhsl_subset_64,
        "bin\\x86_64-w64-mingw32-libgfortran3\\libhsl_subset_64.dll",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
