...
* files in directory, relative to originating `build_tarballs.jl`: `./libHSL.v2024.11.28`
...
* `LibraryProduct`: `libhsl_subset`
* `LibraryProduct`: `libhsl_subset_64`
